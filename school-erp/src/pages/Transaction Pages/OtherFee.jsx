...
const OtherFee = () => {
  ...
  const processPayment = async () => {
    try {
      ...
      // Add entries to OtherFeeLog collection
      const feeLogRef = collection(db, "Schools", auth.currentUser.uid, "Transactions", administrationId, "OtherFeeLog")
      ...
      // Add to OtherBillEntries collection
    ...
    <MainContentPage>
      <Container fluid className="px-0">
        <Card className="shadow-sm">
          ...
          >
            <h2 className="mb-0 h4">Other Fee / Miscellaneous Fee</h2>
          </Card.Header>
