    ...
    return (
      <div className="certificate-content">
        ...
        <div className="certificate-body">
          ...
          {renderField("schoolBoardAnnualExam", "9. School/Board Annual examination last taken with result")}
          {renderField("failedSubjects", "10. Whether failed, if so once/twice in the same class")}
          ...
          {renderField("monthFeePaidUpTo", "13. Month upto which the (pupil has paid) school dues paid")}
          {renderField("feeConcession", "14. Any fee concession availed of: if so, the nature of such concession")}
          {renderField("totalWorkingDays", "15. Total No. of working days in the academic session")}
          {renderField("totalPresentDays", "16. Total No. of working days pupil present in the school")}
          ...
          {renderField("generalConduct", "19. General conduct")}
          {renderField("dateOfApplicationForCertificate", "20. Date of application for certificate")}
          {renderField("dateOfIssueCertificate", "21. Date of issue of certificate")}
