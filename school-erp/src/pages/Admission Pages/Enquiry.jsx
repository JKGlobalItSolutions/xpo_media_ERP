      ...
      <Container fluid className="px-0">
        <div className="admission-form">
          <div className="mb-4 d-flex justify-content-between align-items-center">
            ...
            <Button variant="success" onClick={() => navigate("/admission/enquiry-form")}>
              Add New Enquiry
            </Button>
          </div>
          ...
          <div>
            <div className="mb-4">
              ...
              <div className="d-flex justify-content-between align-items-center mb-3">
                ...
                />
                <Dropdown>
                  <Dropdown.Toggle variant="success" id="dropdown-year-filter">
                  ...
                  {filteredEnquiries.map((enquiry) => (
                    <tr key={enquiry.id}>
                      ...
                      <td>
                        ...
                        <Button variant="danger" size="sm" onClick={() => handleDelete(enquiry.id)}>
                          <FaTrash />
                        </Button>
                      </td>
                    </tr>
