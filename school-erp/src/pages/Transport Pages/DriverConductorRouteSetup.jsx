...
const DriverConductorRouteSetup = () => {
  ...
  const fetchItems = async (category) => {
    ...
    try {
      const itemsRef = collection(db, "Schools", auth.currentUser.uid, "Transport", transportId, `${category}Setup`)
  ...
  const handleEdit = async (category, id, updatedItem) => {
    ...
    try {
      const itemRef = doc(db, "Schools", auth.currentUser.uid, "Transport", transportId, `${category}Setup`, id)
