          ...
          <Col xs={12}>
            <div className="course-setup-container">
              ...
              <nav className="custom-breadcrumb py-1 py-lg-3">
                ...
                <span>Transport</span>
                <span className="separator">&gt;</span>
                <span className="current col-12">Period Bus Collection Report</span>
              </nav>

              <div className="form-card mt-3">
                {/* Header */}
                <div className="header custom-btn-clr p-3">
                  <h2 className="m-0 d-none d-lg-block">Period Bus Collection Report</h2>
                  <h6 className="m-0 d-lg-none">Period Bus Collection Report</h6>
                </div>
...
export default PeriodBusCollection;