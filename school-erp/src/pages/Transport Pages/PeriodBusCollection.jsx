...
const PeriodicalCollectionReport = () => {
  ...
  const generatePDF = () => {
    ...
    doc.setFontSize(14)
    doc.text("PERIODICAL BUS FEES COLLECTION REPORT", 105, 45, { align: "center" })
    doc.setFontSize(10)
  ...
  const downloadPDF = () => {
    const doc = generatePDF()
    doc.save("periodical_bus_collection_report.pdf")
  }
      ...
      <Container fluid className="px-0">
        ...
        <Card className="shadow-sm">
          <Card.Header className="bg-primary text-white py-3">
            <h2 className="mb-0">Periodical Bus Fee Collection Report</h2>
          </Card.Header>
          <Card.Body className="p-4">
            ...
            <div ref={componentRef} className="report-preview">
              <div className="text-center mb-4">
                ...
                <h4 className="report-title">PERIODICAL BUS FEES COLLECTION REPORT</h4>
