          ...
          <Col xs={12}>
            <div className="course-setup-container">
              ...
              <nav className="custom-breadcrumb py-1 py-lg-3">
                ...
                <span className="separator">&gt;</span>
                <span className="current col-12">Course Head</span>
              </nav>

              <div className="form-card mt-3">
                {/* Header */}
                <div className="header p-3">
                  <h2 className="m-0 d-none d-lg-block">Create an Course Head</h2>
                  ...
                  <Form onSubmit={handleSubmit}>
                    <Row className="mb-4 align-items-center">
                      <Col xs={12} lg={4} className="label-col mb-2 mb-lg-0">
                        <Form.Label className="mb-0 ms-lg-5">Enter Course Name</Form.Label>
                      </Col>
                      <Col xs={12} lg={8}>
                        <Form.Control
                          type="text"
