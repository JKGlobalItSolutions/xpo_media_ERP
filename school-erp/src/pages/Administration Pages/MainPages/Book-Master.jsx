          ...
          <Col xs={12}>
            <div className="course-setup-container">
              ...
              <nav className="custom-breadcrumb py-1 py-lg-3">
                ...
                <span className="separator">&gt;</span>
                <span className="current col-12">Book Master</span>
              </nav>

              <div className="form-card mt-3">
                {/* Header */}
                <div className="header p-3">
                  <h2 className="m-0 d-none d-lg-block">Book Subject Setup</h2>
                  <h6 className="m-0 d-lg-none">Book Subject Setup</h6>
                </div>
