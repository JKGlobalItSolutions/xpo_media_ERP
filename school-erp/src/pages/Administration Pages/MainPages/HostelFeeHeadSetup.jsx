...
const HostelFeeHeadSetup = () => {
  ...
  const fetchFeeHeads = async () => {
    ...
    try {
      ...
      console.log("Fetched hostel fee heads:", feeHeadsData)
  ...
  const handleAddFeeHead = async (newFeeHead) => {
    ...
    try {
      ...
      console.log("Hostel fee head added with ID:", docRef.id)
  ...
  const confirmEditFeeHead = async () => {
    try {
      ...
      console.log("Hostel fee head updated:", selectedFeeHead.id)
  ...
  const handleDeleteFeeHead = async (id) => {
    ...
    try {
      ...
      console.log("Hostel fee head deleted:", id)
      setIsDeleteModalOpen(false)
      setSelectedFeeHead(null)
      toast.error("Hostel fee head deleted successfully!", {
        position: "top-right",
        autoClose: 1000,
        hideProgressBar: false,
        closeOnClick: true,
