          ...
          <Col xs={12}>
            <div className="course-setup-container">
              ...
              <nav className="custom-breadcrumb py-1 py-lg-3">
                ...
                <span className="separator">&gt;</span>
                <span className="current col-12">Password Setup
                </span>
              </nav>
              ...
              <div className="form-card mt-3">
                ...
                <div className="header p-3">
                  <h2 className="m-0 d-none d-lg-block">Password Setup</h2>
                  <h6 className="m-0 d-lg-none">Password Setup</h6>
                </div>
                  ...
                  <Form onSubmit={handleSubmit}>
                    <Row className="mb-4 align-items-center">
                      <Col xs={12} lg={4} className="label-col mb-2 mb-lg-0">
                        <Form.Label className="mb-0 ms-lg-5">User Name</Form.Label>
                      </Col>
                      <Col xs={12} lg={8}>
                        <Form.Control
                          type="text"
                    ...
                    <Row className="mb-4 align-items-center">
                      <Col xs={12} lg={4} className="label-col mb-2 mb-lg-0">
                        <Form.Label className="mb-0 ms-lg-5">Password</Form.Label>
                      </Col>
                      <Col xs={12} lg={8}>
                        <Form.Control
                          type="password"
