            ...
            <div className="course-setup-container">
              ...
              <div className="form-card mt-3">
                <div className="header p-3">
                  <h2 className="m-0 d-none d-lg-block ">Student Fee Setup-Regular Candidates</h2>
                  <h6 className="m-0 d-lg-none ">Student Fee Setup-Regular Candidates</h6>
                </div>
...
export default RegularCandidates
