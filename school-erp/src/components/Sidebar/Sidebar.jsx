  ...
  const menuItems = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { id: "2-11", title: "• Payment Setup", path: "/admin/payment-setup" },
        { id: "2-10", title: "• Receipt Setup", path: "/admin/receipt-setup" },
        { id: "2-12", title: "• Staff Master", path: "/admin/staff-master" },
        // { id: "2-13", title: "• Flash Screen", path: "/admin/Flash-Screen" },
        { id: "2-14", title: "• Certificate Preparation", path: "/admin/certificate" },
        { id: "2-15", title: "• Supplier Setup", path: "/admin/supplier-Setup" },
        { id: "2-16", title: "• Password Setup", path: "/admin/password-setup" },
