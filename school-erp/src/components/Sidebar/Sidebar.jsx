  ...
  const menuItems = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { id: "2-2", title: "• Section Setup", path: "/admin/section-setup" },
        { id: "2-3", title: "• Fee Head Setup", path: "/admin/fee-setup" },
        { id: "2-4", title: "• Hostel Fee Head Setup", path: "/admin/Hostel-Fee-Head-Setup" },
        { id: "2-5", title: "• Students Category", path: "/admin/Students-Category" },
        { id: "2-6", title: "• Tuition Fee Setup", path: "/admin/tuition-setup" },
        { id: "2-7", title: "• Hostel Fee Setup", path: "/admin/Hostel-Fee-Setup" },
        { id: "2-8", title: "• Community and Caste Setup", path: "/admin/community-setup" },
        { id: "2-9", title: "• Parent Occupation Setup", path: "/admin/occupation-setup" },
    ...
    },
    {
      ...
      subItems: [
        ...
        { id: "3-2", title: "• QR code Design", path: "/admission/Bar-code-Design" },
        ...
        { id: "3-3", title: "• Student Phone Replace", path: "/admission/phone-number-replace" },
