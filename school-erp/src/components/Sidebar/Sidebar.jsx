  ...
  const menuItems = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { id: "2-15", title: "• Item/Book Master", path: "/admin/item-book-master" },
        { id: "2-16", title: "• Category Head", path: "/admin/category-head" },
        { id: "2-17", title: "• Customer / Staff Master", path: "/admin/customer-staff-master" },
        { id: "2-18", title: "• Book Master", path: "/admin/Book-Master" },
        { id: "2-19", title: "• Book Setup Class Wise", path: "/admin/Book-setup-class-wise" },
      ],
    },
    {
      id: 3,
